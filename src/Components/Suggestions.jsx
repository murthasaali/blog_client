  ...
  return (
    <div className='w-full h-[70%]  flex flex-col'>
         <nav className='w-full p-3 text-cyan-400 font-bold text-xs  h-fit flex justify-between items-center '>
          ...
          Top creators                <button className='p-2'>
            ...
            <div className="grid grid-cols-1 h-[100%] overflow-y-hidden gap-2 p-2">
{
  topBuyers.map((item,index)=>(
    ...
    <div key={index}  className="h-[70px] w-full bg-stone-100 hover:bg-opacity-80 text-stone-400 hover:text-black  transition-all duration-500 bg-opacity-10 justify-start items-center flex p-3 rounded-lg gap-2">
      <div className=''>
